...
CREATE TABLE FREEAGENTAUCTIONBID (
    freeAgentAuctionId INT,
    teamId INT,
    amount INT DEFAULT 0,
    createdDate TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    modifiedDate TIMESTAMP NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (freeAgentAuctionId, teamId),
    FOREIGN KEY (freeAgentAuctionId) REFERENCES FREEAGENTAUCTION (freeAgentAuctionId),
    FOREIGN KEY (teamId) REFERENCES TEAM (teamId)
);
